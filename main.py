...
Данная версия бота является тестовой, просим прощения за неудобства. Будем благодарны, если сообщите о проблеме: @solard_chat_bot
...
В случае, если возникли трудности и вы ознакомились с инструкцией, напишите нашим специалистам: @solard_chat_bot
""",

#################

            'other': """           
Пожалуйста, опишите вашу проблему нашему специалисту: @solard_chat_bot
"""
